...
st.set_page_config(
    ...
    page_icon="⚡",  # Ou insira o caminho para um ícone .ico
    layout="centered",  # "centered" ou "wide" (layout mais largo)
    initial_sidebar_state="expanded"  # "expanded", "collapsed" ou "auto"
)
